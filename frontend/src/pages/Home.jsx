...
const Home = () => {
  return (
    <section className="justify-content-center d-flex align-items-center text-center m-0 p-0 flex-column">
      <img src="./illus.png" alt="" srcset="" className="illus"/>
      <div className="justify-content-center d-flex flex-column align-items-center text-center">
        <h1 className="text-white greet">Hey There !</h1>
