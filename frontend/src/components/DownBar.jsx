...
const DownBar = ({ page }) => {
  ...
  return (
    <div className="d-flex justify-content-between align-items-center downBar p-3">
      <a href="convo">
        <div
          className="icon-1 d-flex justify-content-between align-items-center text-center"
          style={iconStyle1}
        >
          <svg
            className="icon-svg"
      ...
      <a href="connect">
        <div
          className="icon d-flex justify-content-between align-items-center text-center"
          style={iconStyle2}
        >
          <svg
            className="icon-svg"
